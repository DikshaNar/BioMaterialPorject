...
public class BioMaterial implements Serializable{
	...
	public String toString() {
		return "BioMaterial [id=" + id + ", shortDesc=" + shortDesc + ", longDesc=" + longDesc + ", commonName="
				+ commonName + ", mfgName=" + mfgName + ", usdaSurvey=" + usdaSurvey + ", refuseDesc=" + refuseDesc
				+ ", refusePercentage=" + refusePercentage + ", scientificName=" + scientificName + ", nFactor="
				+ nFactor + ", pFactor=" + pFactor + ", fFactor=" + fFactor + ", choFactor=" + choFactor + ", addedBy="
				+ addedBy + ", updatedBy=" + updatedBy + ", citation=" + citation + ", createdAt=" + createdAt
				+ ", updatedAt=" + updatedAt + "]";
	}
