...
public class BioMatSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
        	.antMatchers("/update*","/add*","/selection*", "/delete*", "/addCustom*","/addDiscreet*").authenticated()
        	//.antMatchers(HttpMethod.GET, "/getEditDetailOfCustomBioMaterialUsingId").authenticated()
