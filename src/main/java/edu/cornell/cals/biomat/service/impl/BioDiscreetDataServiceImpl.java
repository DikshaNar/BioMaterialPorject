...
public class BioDiscreetDataServiceImpl implements BioDiscreetDataService{
	...
	@Override
	public List<BioDiscreetData> getBioDiscreetDataByDataSetNameORYVariable(String yVariable) {
		List<BioDiscreetData> bioDiscreetData = bioDiscreetDataRepository.getBioDiscreetDataByDataSetNameORYVariable(yVariable);
		return bioDiscreetData;
	}
}
